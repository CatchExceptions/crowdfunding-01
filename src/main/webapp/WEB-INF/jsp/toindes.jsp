...
<head>
    ...
    <style>
        ...
        #mainBox3 .mHd{border-bottom:2px solid #09c;height:30px;line-height:30px;}
        #mainBox2 .mHd h3{display:initial;*display:inline;zoom:1;padding:0 15px;background:#09c;color:#fff;}
        #mainBox4 .mHd h3 span{color:#fff;font-size:14px;font-weight:bold;}
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html" style="font-size:32px;">创意产品众筹平台</a>
                </div>
